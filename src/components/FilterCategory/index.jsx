	...
	return (
		<div className="c-filter-category">
			<div className="c-filter-category__title-container">
				<h3 className="c-filter-category__title">Categoria</h3>
				<button className="c-filter-category__button">
					<TraceIcon />
				</button>
			</div>

			<h4 className="c-filter-category__subtitle">Home Office</h4>
			...
			<ul className="c-filter-category__list">
				<li className="c-filter-category__item">
					<a href="/">Notebook (9390)</a>
				</li>
				<li className="c-filter-category__item">
					<a href="/">Notebook Gamer (7745)</a>
				</li>
				<li className="c-filter-category__item">
					<a href="/">PC Gamer (1243)</a>
				</li>
				<li className="c-filter-category__item">
					<a href="/">Tablet (2113)</a>
				</li>
				<li className="c-filter-category__item">
					<a href="/">Impressora (1243)</a>
				</li>
				<li className="c-filter-category__item">
					<a href="/">Projetor (870)</a>
				</li>
			</ul>
