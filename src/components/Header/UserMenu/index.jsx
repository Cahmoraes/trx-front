		...
		<div className="c-user-menu">
			...
			<div className="c-user-menu__navigation">
				...
				<ul className="c-user-menu__navigation-list">
					<li>
						<a href="/">
							Escritório <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Home Office <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Ferramentas <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Geek <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Moda <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Móveis e Decoração <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Celulares <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Eletrônicos <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Splits e Ar-condicionado <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Pets <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							Promoções <ArrowSmallRightIcon />
						</a>
					</li>
					<li>
						<a href="/">
							MAIS <ArrowSmallRightIcon />
						</a>
					</li>
				</ul>
			</div>
