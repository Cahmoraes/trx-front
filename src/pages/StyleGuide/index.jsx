			...
			<section className="container-fluid py-5">
				<div className="row justify-content-between">
					<div className="col">
						...
						<Button color="secondary" showIcon>
							Secondary
						</Button>
						<br />
			...
			<section className="container-fluid py-5">
				<div className="row justify-content-between">
					<div className="col">
						...
						<Alert color="warning">Example text alert mensagem warning</Alert>
						<br />

						<Alert color="lamp">Example text alert mensagem lamp</Alert>
						<br />

						<Alert color="info">Example text alert mensagem info</Alert>
						<br />

						<Alert color="error">Example text alert mensagem error</Alert>
					</div>
				</div>
			</section>
			...
			<section className="container-fluid py-5">
				<div className="row justify-content-between">
					<div className="col">
						...
						<AlertContent color="success" showIcon={false}>
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
							condimentum nisl non odio ultricies vehicula. Suspendisse condimentum
							dictum laoreet.
						</AlertContent>
						<br />

						<AlertContent color="warning">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam
							condimentum nisl non odio ultricies vehicula. Suspendisse condimentum
							dictum laoreet.
						</AlertContent>
				...
				<div className="row justify-content-between">
					...
					<div className="col-2">
						<Tooltip position="right">
							...
							ipsum lobortis turpis tempor malesuada.
						</Tooltip>
					</div>
					<div className="col-2">
