          ...
          <div className="col-lg-6 l-product-details__description-container">
            ...
            <div className="l-product-details__share-container">
              <span>
                {
                  favState ?
                    <button onClick={handleFavClick}><HeartTapIcon /> Adicionar à Lista de Favoritos</button> :
                    <button onClick={handleFavClick}><HeartIcon /> Adicionar à Lista de Favoritos</button>
                }
              </span>
              <span>
                {
                  shareState ?
                    <button onClick={handleShareClick}><ShareTapIcon /> Compartilhar</button> :
                    <button onClick={handleShareClick}><ShareIcon /> Compartilhar</button>
                }
                {
                  shareState && (
                    <div className="l-product-details__share-container-options">
                      <button onClick={handleShareClick} className="l-product-details__share-container-close">
                        <CloseIcon />
                      </button>
